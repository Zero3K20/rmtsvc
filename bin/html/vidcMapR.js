...
function disp_vidcsinfo(xmlobj)
{
	...
	if(node.length>0 && (node.item(0).textContent || node.item(0).text)=="1")
	{
		...
		document.getElementById("lblStatus").innerHTML="<font color=green>●</font>Connected to this vIDCs service";
...
function initinfo()
{
	...
	document.getElementById("lblStatus").innerHTML="<font color=red>●</font>Not connected to this vIDCs service";
...
{	
	document.getElementById("lblmapped").innerHTML="<font color=red>●</font>Not mapped to remote vIDCs";
...
function disp_mapinfo(xmlobj)
{
	...
	if(mapped_port>0){
		...
		if(node.length>0 && (node.item(0).textContent || node.item(0).text)=="1")
		{
			...
			document.getElementById("lblmapped").innerHTML="<font color=green>●</font>Mapped to vIDCs...&nbsp;Port:"+mapped_port+s;
		}
		else	document.getElementById("lblmapped").innerHTML="<font color=green>●</font>Mapped to vIDCs...&nbsp;Port:"+mapped_port;
